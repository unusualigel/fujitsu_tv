"""Use serial protocol of fujitsu_tv to obtain state of the projector."""
...
class AcerSwitch(SwitchEntity):
    ...
    def __init__(
        ...
        self._attributes = {
            POWER_MODE: STATE_UNKNOWN,
            AUTO_DISPLAY: STATE_UNKNOWN,
            INPUT_SOURCE: STATE_UNKNOWN,
            ASPECT_RATIO: STATE_UNKNOWN,
            STATE_OFF: STATE_UNKNOWN,
            STATE_ON: STATE_UNKNOWN,
        }

    def _write_read(self, msg: str) -> str:
        """Write to the serial and read the return."""
        ret = ""
